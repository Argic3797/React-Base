...
function Effect() {
    ...
    // 업데이트 될 떄는 실행하지 않으려면 함수의 두 번째 파라미터로 빈 배열을 넣어주면 된다.

    // - 특정 값이 업데이트 될 때만 실행하고 싶을 때
    // useEffect를 사용할 때, 특정 값이 변경될 떄만 호출하고 싶을 경우도 있다.
    ...
    useEffect(() => {
        console.log("컴포넌트가 렌더링 될 떄마다 특정 작업을 수행합니다.");
